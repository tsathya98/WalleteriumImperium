...
class ReceiptValidator:
    ...
    def _validate_mathematical(self, ai_result: Dict[str, Any], result: ValidationResult):
        """Layer 2: Mathematical Validation"""
    ...
    def _validate_business_logic(self, ai_result: Dict[str, Any], result: ValidationResult):
        """Layer 3: Business Logic Validation"""
    ...
    def _validate_data_quality(self, ai_result: Dict[str, Any], result: ValidationResult):
        """Layer 4: Data Quality Assurance"""
        ...
        for i, item in enumerate(items):
            ...
            if len(description) < 10:
                result.add_warning(f"Very short description for item {i}: '{description}'")


def validate_and_fix_result(ai_result: Dict[str, Any]) -> Tuple[Dict[str, Any], ValidationResult]:
    """
